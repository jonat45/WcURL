 ...
 *
 * Projeto          WcURL
 *                  É um Wrapper para biblioteca cURL (libcurl.dll)
 *
...
const
     // Porque CURL_EXTERN é igual "libcurl.dll"?
...
Type
  ...
  */
  ...
  CURLOPT_LASTENTRY /* the last unused */
     ...
     function curl_easy_init: CURL; external CURL_EXTERN;
     function curl_easy_setopt(PCURL: CURL; ): CURLcode; external CURL_EXTERN;
